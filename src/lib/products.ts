...
const mockProducts: Product[] = [
  {
    ...
    price: 120,
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    imageUrl: 'https://picsum.photos/seed/blouse1/600/800',
    images: ['https://picsum.photos/seed/blouse2/600/800', 'https://picsum.photos/seed/blouse3/600/800', 'https://picsum.photos/seed/blouse4/600/800'],
    category: 'Tops',
    isFeatured: true,
  },
  {
    ...
    price: 150,
    sizes: ['S', 'M', 'L'],
    imageUrl: 'https://picsum.photos/seed/skirt1/600/800',
    images: ['https://picsum.photos/seed/skirt2/600/800', 'https://picsum.photos/seed/skirt3/600/800'],
    category: 'Bottoms',
    isFeatured: true,
  },
  {
    ...
    price: 280,
    sizes: ['S', 'M', 'L', 'XL'],
    imageUrl: 'https://picsum.photos/seed/trench1/600/800',
    images: ['https://picsum.photos/seed/trench2/600/800'],
    category: 'Outerwear',
  },
  {
    id: '4',
    ...
    price: 90,
    sizes: ['XS', 'S', 'M', 'L'],
    imageUrl: 'https://picsum.photos/seed/cami1/600/800',
    category: 'Tops',
    isFeatured: true,
  },
  {
    ...
    price: 180,
    sizes: ['One Size'],
    imageUrl: 'https://picsum.photos/seed/cardi1/600/800',
    category: 'Knitwear',
  },
  {
    id: '6',
