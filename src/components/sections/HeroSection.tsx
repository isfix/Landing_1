  ...
  return (
    <section className="relative w-full h-[calc(100vh-5rem)] min-h-[500px] md:min-h-[600px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 p-6 max-w-3xl mx-auto bg-black/30 backdrop-blur-sm rounded-xl">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white mb-6 font-headline animate-fadeIn" style={{ animationDelay: '0.2s' }}>
          Rune Essence
        </h1>
        <p className="text-lg sm:text-xl text-gray-200 mb-8 max-w-xl mx-auto animate-fadeIn" style={{ animationDelay: '0.4s' }}>
