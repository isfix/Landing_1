...
export function ProductCard({ product }: ProductCardProps) {
  return (
    <Card className="overflow-hidden rounded-xl transform transition-all duration-300 hover:-translate-y-1 h-full flex flex-col animate-fadeIn bg-background shadow-xl hover:shadow-2xl">
