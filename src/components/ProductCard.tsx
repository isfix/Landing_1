...
export function ProductCard({ product }: ProductCardProps) {
  return (
    <Card className="overflow-hidden rounded-xl glassmorphic transform transition-all duration-300 hover:shadow-subtle hover:-translate-y-1 h-full flex flex-col">
